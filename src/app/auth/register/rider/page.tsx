    ...
    <div className="min-h-dvh bg-gradient-to-br from-[#9C4A35] to-[#E65100] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <h1 className="text-3xl font-bold text-white">สมัครไรเดอร์</h1>
          <p className="text-white/80 text-sm mt-1">ลงทะเบียนรับจ็อบส่งอาหาร</p>
        </div>
          ...
          {step === 'form' && (
            <div className="space-y-4">
              ...
              <select
                ...
                className="w-full border border-gray-300 rounded-xl px-4 py-3.5 text-lg focus:outline-none focus:border-[#E65100] focus:ring-2 focus:ring-[#E65100]/10 transition appearance-none bg-white"
              >
                <option value="">เลือกโซน (ไม่บังคับ)</option>
                {zones.map((z) => (
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-[#E65100] to-[#F57C00] text-white rounded-xl py-3.5 font-semibold text-lg disabled:opacity-50 transition hover:shadow-lg active:scale-[0.98]"
              >
                {submitting ? 'กำลังสมัคร...' : 'สมัครไรเดอร์'}
              </button>
            </div>
          )}
        </div>
